      ...
      <div className="space-y-4">
        <div className="flex items-center">
          <div className="flex-shrink-0 w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center">
            <Phone className="text-[var(--color)] w-6 h-6" />
          </div>
          <div className="ml-4">
            ...
            <a
              ...
              target="_blank"
              className="text-[var(--color)] underline transition-all duration-500 hover:font-bold"
            >
              +39 3394955810
            </a>
          </div>
        ...
        <div className="flex items-center">
          <div className="flex-shrink-0 w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center">
            <Mail className="text-[var(--color)] w-6 h-6" />
          </div>
          <div className="ml-4">
        ...
        <div className="flex items-center">
          <div className="flex-shrink-0 w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center">
            <MapPin className="text-[var(--color)] w-6 h-6" />
          </div>
          <div className="ml-4">
